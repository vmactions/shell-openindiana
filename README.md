# shell-openindiana
Get a free shell for openindiana

If you need a openindiana VM shell, you can use this repo.
...
Click "Shell" -> "Start a openindiana shell",  to open the log window, you will see a openindiana vm is booting there.

Wait about 5-8 minutes, the openindiana vm will be ready.
...
```
Mac-1606142911434:shell-openindiana runner$
```

Then you can ssh to the openindiana VM:

```
Mac-1606142911434:shell-openindiana runner$  ssh openindiana
...
Uses: https://github.com/vmactions/openindiana-vm
